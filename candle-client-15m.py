...
def on_message(ws, message):
    ...
    if candle_data["e"] == "kline":
        ...
        print(data)
        r.zadd(symbol+"15m", {data: timestamp})  # Add received data to redis
...
def on_open(ws):
    pairs = ["ethusdt@kline_15m", "btcusdt@kline_15m", "avaxusdt@kline_15m", "bnbusdt@kline_15m"]  # Set tick data pairs
    payload = {
        "method": "SUBSCRIBE",
        "params": pairs,
        "id": 1
