...
def on_message(ws, message):
    ...
    if candle_data["e"] == "kline":
        ...
        print(data)
        r.zadd(symbol+"30m", {data: timestamp})  # Add received data to redis
...
def on_open(ws):
    pairs = ["ethusdt@kline_30m", "btcusdt@kline_30m", "avaxusdt@kline_30m", "bnbusdt@kline_30m"]  # Set tick data pairs
    payload = {
        "method": "SUBSCRIBE",
        "params": pairs,
        "id": 1
