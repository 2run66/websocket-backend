...
def on_message(ws, message):
    ...
    if candle_data["e"] == "kline":
        ...
        print(data)
        r.zadd(symbol+"5m", {data: timestamp})  # Add received data to redis
...
def on_open(ws):
    pairs = ["ethusdt@kline_5m", "btcusdt@kline_5m", "avaxusdt@kline_5m", "bnbusdt@kline_5m"]  # Set tick data pairs
    payload = {
        "method": "SUBSCRIBE",
        "params": pairs,
        "id": 1
